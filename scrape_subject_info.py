...
with open('csv/subject_info.csv', 'w', newline='', encoding='utf-8') as csv_file:
...
df_cleaned.to_csv('csv/subject_info_cleaned.csv', index=False)
print("Duplicates removed and saved to 'csv/subject_info_cleaned.csv'")